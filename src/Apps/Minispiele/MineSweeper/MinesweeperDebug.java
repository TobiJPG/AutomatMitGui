...
public class MinesweeperDebug extends JFrame {
    private static final int GRID_SIZE = 10; // Gittergröße: 10x10
    private static final int NUM_MINES = 10; // Anzahl der Minen
    private JButton[][] buttons = new JButton[GRID_SIZE][GRID_SIZE];
    private boolean[][] mines = new boolean[GRID_SIZE][GRID_SIZE]; // Minenpositionen
    private boolean[][] revealed = new boolean[GRID_SIZE][GRID_SIZE]; // Aufgedeckte Felder
    private boolean[][] flagged = new boolean[GRID_SIZE][GRID_SIZE]; // Mit Flagge markierte Felder
    ...
    public MinesweeperDebug(JFrame mainFrame) {
    ...
    private void restartGame() {
        ...
        MinesweeperDebug newGame = new MinesweeperDebug(mainFrame); // Neues Minesweeper-Spiel erstellen
